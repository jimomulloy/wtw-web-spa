...
spa.chat = (function() {
	...
	var configMap = {
		main_html : String() + '<div class="spa-chat">'
				...
				+ '</div>' + '<div class="spa-chat-closer">x</div>'
				...
				+ '<form class="spa-chat-msg-form">' + '<input type="text"/>'
	...
	onSetchatee = function(event, arg_map) {
		...
		jqueryMap.$list_box.find('.spa-chat-list-name').removeClass(
				'spa-x-select').end().find(
